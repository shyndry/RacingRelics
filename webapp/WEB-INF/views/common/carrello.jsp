...
<main class="main-content">
    <div class="container">
        ...
        <div id="errorBox" class="alert-error" style="display: ${not empty errorMessage ? 'block' : 'none'};">
                        ...
                        <c:when test="${not empty sessionScope.utenteLoggato}">
                            <div class="checkout-section" style="background: var(--surface); padding: 24px; border-radius: 8px; border: 1px solid var(--border); margin-top: 20px;">
                                ...
                                <form action="${pageContext.request.contextPath}/Checkout" method="POST" class="checkout-form">
                                    ...
                                    <div id="newAddressContainer" style="display: ${empty listaIndirizzi ? 'block' : 'none'}; border-top: 1px solid var(--border-soft); padding-top: 15px; margin-top: 15px;">
